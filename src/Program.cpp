...
int main(int argc, char** argv) {
	...
	renderer->Initialize(&Window, "res/scenes/LAZIENKA.gltf", "res/sky/ibl/Topanga_Forest_B_3k.hdr"); // // salle_de_bain.obj //res/sky/ibl/NarrowPath_3k.hdr // Topanga_Forest_B_3k
